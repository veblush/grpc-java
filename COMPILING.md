...
### Build Protobuf
The codegen plugin is C++ code and requires protobuf 3.14.1 or later.

For Linux, Mac and MinGW:
```
$ PROTOBUF_VERSION=3.14.1
...
```
.\gradlew publishToMavenLocal ^
    -PvcProtobufInclude=C:\path\to\protobuf-3.14.1\src ^
    -PvcProtobufLibs=C:\path\to\protobuf-3.14.1\vsprojects\Release ^
    -PtargetArch=x86_32
```
...
```
vcProtobufInclude=C:\\path\\to\\protobuf-3.14.1\\src
vcProtobufLibs=C:\\path\\to\\protobuf-3.14.1\\vsprojects\\Release
targetArch=x86_32
```
