...
### Build Protobuf
The codegen plugin is C++ code and requires protobuf 3.15.9 or later.

For Linux, Mac and MinGW:
```
$ PROTOBUF_VERSION=3.15.9
...
```
.\gradlew publishToMavenLocal ^
    -PvcProtobufInclude=C:\path\to\protobuf-3.15.9\src ^
    -PvcProtobufLibs=C:\path\to\protobuf-3.15.9\vsprojects\Release ^
    -PtargetArch=x86_32
```
...
```
vcProtobufInclude=C:\\path\\to\\protobuf-3.15.9\\src
vcProtobufLibs=C:\\path\\to\\protobuf-3.15.9\\vsprojects\\Release
targetArch=x86_32
```
